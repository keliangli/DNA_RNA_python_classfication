...
h5py_Path = r"F:\DNA_RNA_deeplearning\DNA_file\DNA_h5py"
...
for h5py_file_name in h5py_Path_listdir:
    ...
    if h5py_data.shape[0]>(windows_size-1):
        ...
        while(counter < (h5py_data.shape[0]-(windows_size-1)/2)):
            ...
            data_y[int(counter-(windows_size-1)/2)] = h5py_data[int(counter),-1]
            counter = counter + 1
    ...
    print(p_data_y.shape)
    print(p_data_x.shape)

    if p_row_num :
        f=h5py.File("5x25_"+h5py_file_name,"w")
